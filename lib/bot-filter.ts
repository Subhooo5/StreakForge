...
/**
 * Reads and returns the list of ignored authors configured in the .streakforge.json file.
 ...
 * Matches:
 * 1. Custom authors defined in the ignored_authors list inside .streakforge.json
