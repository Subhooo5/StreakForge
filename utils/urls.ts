const FALLBACK_ORIGIN = 'https://streakforge.vercel.app';
 ...
 * 3. Hardcoded fallback (`https://streakforge.vercel.app`).
 *
 * @returns {string} The resolved base origin URL (e.g. `https://streakforge.app` or `http://localhost:3000`).
 */
 ...
 * @returns {string} The absolute dashboard URL (e.g. `https://streakforge.app/dashboard/octocat`).
 */
