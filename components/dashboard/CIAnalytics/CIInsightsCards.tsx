...
const InsightCard = ({ title, value, sub, icon: Icon, color, delay }: InsightCardProps) => (
  <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay }} className="group relative overflow-hidden bg-white/70 dark:bg-zinc-900/50 backdrop-blur-xl border border-black/10 dark:border-white/10 rounded-2xl p-5 flex flex-col gap-3 hover:shadow-lg transition-all duration-300">
